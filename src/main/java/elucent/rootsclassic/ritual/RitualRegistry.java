...
import elucent.rootsclassic.ritual.rituals.*;
...
public class RitualRegistry {
    public static final LazyRegistrar<RitualBase> RITUALS = LazyRegistrar.create(RitualBaseRegistry.registryLocation, Const.MODID);
