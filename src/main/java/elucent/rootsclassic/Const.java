...
public class Const {
    ...
    public static final String NBT_POTENCY = MODID + ":potency";
    public static final String NBT_EFFECT = MODID + ":effect";
    public static final String NBT_SELECTED = MODID + ":selected";
}
